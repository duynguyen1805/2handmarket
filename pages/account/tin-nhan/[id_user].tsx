    ...
    <>
      ...
      <div className="h-auto w-full bg-gray-100 pt-3">
        <div className="h-auto w-full flex items-center justify-center">
          <div className="h-[800px] max-h-[2500px] w-[990px] flex border rounded-lg bg-white">
            {/* display medium */}
                ...
                conversationMembers.map((receiver: any, index: number) => {
                  return (
                    <button
                      ...
                      className="h-[90px] w-full flex items-center space-x-2 px-2 border-b border-gray-300 cursor-pointer"
                    >
                      <div
