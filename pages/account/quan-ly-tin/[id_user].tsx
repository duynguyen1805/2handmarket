                    ...
                    >
                      ...
                      <div className="w-[780px] flex items-center place-content-between">
                        ...
                        <div
                          ...
                          } h-full w-[150px] flex flex-col items-end justify-end p-2`}
                        >
                          {isOpen === 1 && (
                            <div
                          ...
                          {isOpen === 2 && (
                            <div
                              className={`relative h-auto w-auto px-6 py-1 mb-2 border border-gray-500 hover:bg-gray-200 rounded-md flex items-center justify-center text-lg`}
                              onClick={() =>
                          ...
                          {isOpen === 2 && (
                            <div
                              className={`h-auto w-auto px-5 py-1 mb-2 border border-red-500 hover:bg-red-500 hover:text-white rounded-md flex items-center justify-center text-lg`}
                              onClick={() =>
                                handlebutton_huytin(item.type, item._id)
                              }
                            >
                            ...
                            <button
                              ...
                              className={`${
                                item.trangthaithanhtoan == 1
                                  ...
                                  : ""
                              } h-auto w-auto px-5 py-1 border border-mauxanhtroi hover:bg-mauxanhtroi hover:text-white rounded-md flex items-center justify-center text-lg`}
                              onClick={() =>
