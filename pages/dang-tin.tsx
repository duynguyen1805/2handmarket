        ...
        <div className="bg-white shadow-sm h-auto min-h-[570px] w-[960px] pb-5">
          ...
          <div className="h-auto w-full flex">
            <div className="h-full w-[320px] px-2 space-y-2">
              <p className="font-bold">Hình ảnh và Video sản phẩm</p>
            ...
            <div className="h-auto w-[640px] px-2 space-y-3">
                    ...
                    {chitiet_danhmuc &&
                      chitiet_danhmuc.map((item: sub_danhmuc) => {
                        return (
                          ...
                          >
                            {typeDanhmuc && typeDanhmuc === "phuongtien" && (
                              <Image
                                src={
                                  item.type == "oto"
                                    ? icon_oto
                            ...
                            {typeDanhmuc && typeDanhmuc === "dodungcanhan" && (
                              <Image
                                src={
                                  item.type == "quanao"
                                    ? icon_quanao
              ...
              {typeDanhmucChitiet &&
                ...
                typeDanhmuc !== "thucung" && (
                  <>
                    <p className="text-lg font-bold pt-3">Thông tin chi tiết</p>
              ...
              {typeDanhmucChitiet && typeDanhmucChitiet === "maytinhbang" && (
                <Dangtin_maytinhbang
                  settypeHang={settypeHang}
                  dongmay={dongmay}
                  setdongmay={setdongmay}
