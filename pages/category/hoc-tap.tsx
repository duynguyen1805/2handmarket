...
const Hoc_tap = () => {
  ...
  useEffect(() => {
    fetchDataProduct();
  }, [pagehientai, type_danhmuchoctap]);
  const fetchDataProduct = async () => {
    if (!type_danhmuchoctap) {
      try {
        const build_data = {
          type: "ALL",
          soluong: 36,
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <Head>
        <title>2Hand Market - Học tập</title>
          ...
          <div className="text-lg font-bold w-full flex items-center justify-center mt-2">
            <div className="h-[30px] w-[960px] overflow-hidden">
              <p className="running-text">
                Mua bán, trao đổi đồ dùng học tập thuận tiện, nhanh chóng
              </p>
            </div>
          </div>
          {/* Option */}
                        ...
                        return (
                          <div key={item.key} className="h-full w-[150px]">
                            <div className="h-[80px] w-full flex items-center justify-center">
                              ...
                              >
                                {(item.type === "giaotrinh" && "Giáo trình") ||
                                  (item.type === "sachthamkhao" && "Sách TK") ||
