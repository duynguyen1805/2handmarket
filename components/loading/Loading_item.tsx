    ...
    >
      <div className="flex flex-col space-y-1 h-full">
        ...
        <div className="sm:h-[50px] md:h-[60px] w-full">
          <div className="sm:h-[22px] md:h-[25px] w-[90%] slideBackground_loading"></div>
          <div className="sm:h-[22px] md:h-[25px] w-2/3 slideBackground_loading"></div>
        </div>
        <p className="sm:h-[22px] md:h-[24px] w-full slideBackground_loading"></p>
        <p className="sm:h-[22px] md:h-[24px] w-5/6 slideBackground_loading"></p>
      </div>
    </motion.div>
  );
};
